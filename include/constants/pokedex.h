...
// Regional (pre-National) numerical list: 001..151 then reserved shown as 152..(151+N).
#define KANTO_DEX_SLOT_COUNT_WITH_RESERVED ((u16)(KANTO_DEX_COUNT + NUM_RESERVED_CUSTOM_SPECIES))
#else
...
#define KANTO_DEX_SLOT_COUNT_WITH_RESERVED KANTO_DEX_COUNT
#endif
