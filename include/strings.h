...
extern const u8 gText_PromptStoneEnterPrompt[];
extern const u8 gText_PromptStoneWaiting[];
extern const u8 gText_PromptStoneUsedOn[];
extern const u8 gText_PromptStoneQueueFull[];
