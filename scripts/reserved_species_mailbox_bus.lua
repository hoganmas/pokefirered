...
return function(M)
    ...
    function M.readMailbox(emu, base)
        return {
            ...
            monIconTable = r32(emu, base + M.OFFSET_MON_ICON_TABLE),
            monFootprintTable = r32(emu, base + M.OFFSET_MON_FOOTPRINT_TABLE),
            runtimeIconDataAddr = r32(emu, base + M.OFFSET_RUNTIME_ICON_DATA),
            runtimeFootprintDataAddr = r32(emu, base + M.OFFSET_RUNTIME_FOOTPRINT_DATA),
