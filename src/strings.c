...
const u8 gText_PromptStoneEnterPrompt[] = _("Enter evolution prompt");
const u8 gText_PromptStoneWaiting[] = _("...");
const u8 gText_PromptStoneUsedOn[] = _("You used the {STR_VAR_2}\non {STR_VAR_1}!{PAUSE_UNTIL_PRESS}");
const u8 gText_PromptStoneQueueFull[] = _("Too many requests are pending.\nPlease try again later.{PAUSE_UNTIL_PRESS}");
